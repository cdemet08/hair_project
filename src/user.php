...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a href="user.php" id="Name">Hair Salon</a>
        </div>

        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">

                <li ><a href="user.php"><font size="5">Home  </font></a>      </li>
            ...
            <ul id="Logout" class="nav navbar-nav navbar-right">
                 <li  class="dropdown" >
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <li><a id="settingsButton" onclick="document.getElementById('myAppointments').style.display='block'" type="text" data-toggle="modal" data-target="#gridSystemModal">My Appointments</a></li>
                       <li><a id="settingsButton" onclick="document.getElementById('accountSettings').style.display='block'" type="text" data-toggle="modal" data-target="#gridSystemModal">Account Settings</a></li>
...
<form id="myAppointments"  class="modal" >

    <div class="modal-content" action="action_page.php" >
        <div class="modal-header" >
            <div class="col-sm-offset-4 col-sm-8">
                <span onclick="document.getElementById('myAppointments').style.display='none'" class="close" title="Close Modal">&times;</span>
                <img src="img/schedule.png" alt="Avatar" class="avatar" >

            </div>
        </div>

        <div class="modal-body" style="padding-top: 50px">
            <div id="cal" style="width:auto; height:auto; overflow-x:scroll;overflow-x:auto; overflow-y:scroll; " >
                <table class="table1" id="tableAppointments" cellpadding="5" cellspacing="2">
                    <thead>
                        <tr style="color:#000;">
                            <th> Date  </th>
                            <th> Hour   </th>
                    ...
                    <tbody>
                         <tr><td>  <input size="6px"></td>
                             <td>  <input size="6px"></td>
                             <td>  <input size="6px"></td>
                             <td>  <input size="6px"></td>
                             <td><button  class="btn btn-sm btn-info"type="button" style= "  background-color: inherit; font-size: 30px;  font-family: inherit; color: black; margin-left: 30%; margin-top: 1%; ">Delete</button></td>
                         </tr>
                    </tbody>
                </table>
             </div>
    ...
    <div class="modal-content" action="action_page.php">
        ...
        <div class="modal-body" style="padding-top: 50px">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button id="newEmail" type="button" style="width:100px">Change</br> Email</button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <label id="pass"class="control-label " for="password">Current Password:</label>
                </div>
                <div class="col-sm-8">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <label id="pass"class="control-label " for="password">New Password:</label>
                </div>
                <div class="col-sm-8">
                    <input type="password" name="password" style="height: 50px" class="form-control" placeholder="Password" id="password">
                </div>
                <div class="col-sm-2">
                    <button id="newPassword" type="button" style="width:100px">Change Password</button>
                </div>
            </div>
                         ...
                         <form id="appointment_form"  action="includes/appointment_save.php" method="post" >
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <input type="submit" name="submit_appointment" value="Submit" onclick="appointmenForUser(this.form)"; class="btn btn-default" data-dismiss="modal" style="margin-right: 50%" >
    ...
    <h1 class="headerstyle" ><a name="contact">Contact Us</h1>
        ...
        <div class="row">
            ...
            <div class="col-sm-3" style="color:white;">
                ...
                <span  ><strong>Address:University of Cyprus,1 Panepistimiou Avenue Aglantzia,<br>2109 Nicosia<br></strong></span>
